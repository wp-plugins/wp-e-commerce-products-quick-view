...
class WPEC_QV_Admin_Interface extends WPEC_QV_Admin_UI
{
	...
	public function admin_forms( $options, $form_key, $option_name = '', $form_messages = array() ) {
						...
						<td class="forminp forminp-border_corner">
                           ...
                           <!-- Border Corner : Rounded or Square -->
								<input
                                    ...
                                    <?php echo implode( ' ', $custom_attributes ); ?>
								/> 
                                <span class="a3rev-ui-border_corner-span"><?php _e( 'Rounded Value', 'wpecquickview' ); ?></span> 
		...
		<?php do_action( $this->plugin_name . '-' . trim( $form_key ) . '_settings_end' ); ?>
            <p class="submit">
                    <input type="submit" value="<?php _e('Save changes', 'wpecquickview'); ?>" class="button-primary" name="bt_save_settings" />
