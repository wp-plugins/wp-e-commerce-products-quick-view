...
<?php
/*-----------------------------------------------------------------------------------
WPEC Quick View Custom Template Gallery Tab
...
class WPEC_QV_Custom_Template_Gallery_Tab extends WPEC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'label'				=> __( 'Gallery Settings', 'wpecquickview' ),
			'callback_function'	=> 'wpec_qv_custom_template_gallery_tab_manager',
		);
...
global $wpec_qv_custom_template_gallery_tab;
$wpec_qv_custom_template_gallery_tab = new WPEC_QV_Custom_Template_Gallery_Tab();

/** 
 * wpec_qv_custom_template_gallery_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_qv_custom_template_gallery_tab_manager() {
	global $wpec_qv_custom_template_gallery_tab;
	$wpec_qv_custom_template_gallery_tab->tab_manager();
}
