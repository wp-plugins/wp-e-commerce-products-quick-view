...
<?php
/*-----------------------------------------------------------------------------------
WPEC Quick View Custom Template Product Data Tab
...
class WPEC_QV_Custom_Template_Product_Data_Tab extends WPEC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'wpec-quick-view-custom-template';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'product-data',
			'label'				=> __( 'Product Data', 'wpecquickview' ),
			'callback_function'	=> 'wpec_qv_custom_template_product_data_tab_manager',
		);
...
global $wpec_qv_custom_template_product_data_tab;
$wpec_qv_custom_template_product_data_tab = new WPEC_QV_Custom_Template_Product_Data_Tab();

/** 
 * wpec_qv_custom_template_product_data_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_qv_custom_template_product_data_tab_manager() {
	global $wpec_qv_custom_template_product_data_tab;
	$wpec_qv_custom_template_product_data_tab->tab_manager();
}
