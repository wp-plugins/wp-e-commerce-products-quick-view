...
<?php
/*-----------------------------------------------------------------------------------
WPEC Quick View Custom Template Global Tab
...
class WPEC_QV_Custom_Template_Global_Settings_Tab extends WPEC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpec_qv_custom_template_global_settings_tab_manager',
		);
...
global $wpec_qv_custom_template_global_settings_tab;
$wpec_qv_custom_template_global_settings_tab = new WPEC_QV_Custom_Template_Global_Settings_Tab();

/** 
 * wpec_qv_custom_template_global_settings_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_qv_custom_template_global_settings_tab_manager() {
	global $wpec_qv_custom_template_global_settings_tab;
	$wpec_qv_custom_template_global_settings_tab->tab_manager();
}
