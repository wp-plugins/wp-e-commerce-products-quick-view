...
<?php
/*-----------------------------------------------------------------------------------
WPEC Quick View Admin Button Style Tab
...
class WPEC_QV_Admin_Button_Style_Tab extends WPEC_QV_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'button-style',
			'label'				=> __( 'Button Style', 'wpecquickview' ),
			'callback_function'	=> 'wpec_qv_admin_button_style_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/hover-position-style-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/under-image-style-settings.php' );
...
global $wpec_qv_admin_button_style_tab;
$wpec_qv_admin_button_style_tab = new WPEC_QV_Admin_Button_Style_Tab();

/** 
 * wpec_qv_admin_button_style_tab_manager()
 * Define the callback function to show tab content
 */
function wpec_qv_admin_button_style_tab_manager() {
	global $wpec_qv_admin_button_style_tab;
	$wpec_qv_admin_button_style_tab->tab_manager();
}
