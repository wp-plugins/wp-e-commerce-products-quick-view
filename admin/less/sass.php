...
class WPEC_QV_Less
{
	...
	public $css_file_name = 'wpec_quick_view_button';
	public $plugin_folder = WPEC_QV_ULTIMATE_FOLDER;
	public $plugin_dir = WPEC_QV_ULTIMATE_DIR;
